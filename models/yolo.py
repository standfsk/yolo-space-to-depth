...
# https://github.com/z1069614715/objectdetection_script/blob/master/yolo-improve/yolov7-DecoupledHead.py
...
class Model(nn.Module):
    ...
    def forward_once(self, x, profile=False):
        ...
        for m in self.model:
            ...
            if profile:
                c = isinstance(m, (Detect, IDetect, IAuxDetect, IBin, IDetect_Decoupled))
